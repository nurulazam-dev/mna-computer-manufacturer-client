            ...
            <table className="table w-full">
                ...
                <thead>
                  <div>
                    <img
                      ...
                      src="https://i.ibb.co/M9NFR3K/20211227-124649.jpg"
                      alt=""
                    />
              ...
              <tbody className="text-xl">
                ...
                <tr>
                  ...
                  <td>
                    <a
                      href="https://mna-cars-warehouse.web.app/"
                      className="mx-2 text-"
                    >
                      Project 1:{" "}
                      <span className="text-blue-500">MNA Cars Warehouse</span>{" "}
                    </a>{" "}
                    <br />
                    <a
                      href="https://mna-munna-photographer.web.app/"
                      className="mx-2 text-"
                    >
                      Project 2:{" "}
                    ...
                    <br />
                    <a
                      href="https://mna-bike-bazar.netlify.app/"
                      className="mx-2 text-"
                    >
                      Project 3:{" "}
                      <span className="text-blue-500">MNA Bike Bazar</span>{" "}
                    </a>
                  </td>
                </tr>
              </tbody>
