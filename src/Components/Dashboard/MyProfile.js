            ...
            <div>
              ...
              <div className="form-control w-full my-3">
                <label className="input-group">
                  ...
                  <input
                    type="number"
                    value={contact ? contact : "Your contact wasn't updated"}
                    className="input text-xl input-bordered w-full"
                    disabled
                  />
                </label>
              ...
              <div className="form-control w-full my-3">
                <label className="input-group">
                  ...
                  <input
                    type="text"
                    value={
                      education ? education : "Your education wasn't updated"
                    }
                    className="input text-xl input-bordered w-full"
                    disabled
                  />
              ...
              <div className="form-control w-full my-3">
                <label className="input-group">
                  ...
                  <input
                    type="text"
                    value={address ? address : "Your address wasn't updated"}
                    className="input text-xl input-bordered w-full "
                    disabled
                  />
                </label>
                ...
                <label className="input-group">
                  ...
                  <input
                    ...
                    value={
                      portfolio
                        ? portfolio
                        : "Your portfolio link wasn't updated"
                    }
                    className="input text-xl input-bordered w-full "
                    disabled
                  />
              ...
              <div className="form-control w-full my-3">
                <label className="input-group">
                  ...
                  <input
                    type="text"
                    value={
                      linkedIn ? linkedIn : "Your linkedIn link wasn't updated"
                    }
                    className="input text-xl input-bordered w-full "
                    disabled
                  />
        ...
        <div className="card w-2/6 bg-white shadow-xl mx-7">
          <div className="card-body">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <input
                type="submit"
                className="btn my-2 text-white btn-active w-full"
                value="Update"
              />
            </form>
          </div>
