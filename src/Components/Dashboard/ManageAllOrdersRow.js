...
const ManageAllOrdersRow = ({ order, index, refetch }) => {
    ...
    const { _id, customer, customerName, productName, paid, shipment } = order || "";
            ...
            <tr>
                ...
                <td>
                    {paid ? (
                        ...
                        <div className="tooltip tooltip-primary" data-tip="Payment is not completed yet" >
                ...
                <td>
                    {paid ? (
                        <>
                            {!shipment ? (
                                <div className="tooltip tooltip-secondary" data-tip="Place for shipment" >
                                    <button className="btn btn-sm btn-secondary text-white" onClick={handlePending}>
                                        Pending
                                    </button>
                                </div>
                            ) : (
                        ...
                        <>
                            <div className="tooltip tooltip-warning" data-tip="Delete customer's order" >
                                <label htmlFor="admin-delete-single-order" className="btn btn-sm btn-warning modal-button"
                                    onClick={() => setAdminOrderDelete(order)} >
                                    Cancel <FontAwesomeIcon className='' icon={faTrashAlt}></FontAwesomeIcon>
                                </label>
                            </div>
                        </>
                    )}
