    ...
    <section className="mb-12">
      ...
      <div className="hero">
        <div className="hero-content flex-col lg:flex-row">
          ...
          <div className="">
            <div>
              <h1 className="text-3xl lg:text-3xl font-bold capitalize">
                We always try to present our business in the best way
              </h1>
              <div className="text-[14px]">
                <p>
                  Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                  Animi, nam?Lorem ipsum dolor, Lorem ipsum dolor sit, amet
                  Lorem ipsum
                </p>
                <p>
                  sit amet consectetur Lorem ipsum dolor sit, amet adipisicing
                  elit. Accusantium, ea.sit amet consectetur adipisicing elit.
                  Accusantium,
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
              <div className="flex items-center shadow-2xl px-2 lg:px-5 py-3">
                <div className="mr-3">
                  <FontAwesomeIcon
                    icon={faTruckFast}
                    className="text-green-600 text-[32px]"
                  />
                </div>
                <div>
