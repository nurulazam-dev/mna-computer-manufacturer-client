            ...
            <div className="w-full flex_block gap-4">
                ...
                <div className='w-full md:w-2/5 lg:w-4/6 p-4'>
                    ...
                    <div className='flex flex-col justify-center gap-2'>
                        ...
                        <div>
                            <textarea
                                className='textarea w-full mb-4 input-bordered'
                                placeholder='Your message'
                                rows={4}
                            ></textarea>
                        </div>
                        <div>
                            <button className="btn btn-outline border-pink-700 text-xl">
                                Send Message <FontAwesomeIcon className='mx-4' icon={faPaperPlane} />
                            </button>
                        </div>
                    </div>
                </div>
