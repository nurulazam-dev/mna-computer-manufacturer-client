...
const Product = ({ product }) => {
    ...
    return (
        <div className="card lg:max-w-lg bg-base-100 border rounded-none shadow-xl">
            ...
            <div className="card-body mt-0 py-1 ">
                ...
                <p className='text-sm'><span className='font-bold text-xl'>$ {price} </span> /per unit</p>
                ...
                <div className="card-actions justify-center">
                    <button
                        ...
                        className="btn btn-outline border-blue-700  w-full max-w-sm my-2">
                        Purchase
                    </button>
                </div>
            </div>
