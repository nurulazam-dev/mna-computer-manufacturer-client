...
const faqsData = [
  {
    ...
    ans: "This website is about a Computer Manufacturer parts selling website ( MNA Computer Manufacturer ). MNA_Computer_Manufacturer basically all new products are available.",
  },
  {
    id: 2,
    title: `Are MNA_Computer_Manufacturer's products sold in installments?`,
  ...
  {
    id: 3,
    title: `Are MNA_Computer_Manufacturer's products original?`,
    ans: `MNA_Computer_Manufacturer's all products are original. There is no opportunity to display any brand clone or fake product under the brand name. So you will find here the original product of any brand.`,
  },
];
